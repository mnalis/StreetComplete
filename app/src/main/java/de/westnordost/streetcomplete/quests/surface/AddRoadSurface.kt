...
class AddRoadSurface : OsmFilterQuestType<SurfaceAndNote>() {
    ...
    override val elementFilter = """
        ...
        and (
          surface ~ asphalt|cobblestone|cobblestone:flattened|sett|concrete|concrete:plates|paving_stones|metal|wood|unhewn_cobblestone|chipseal|brick|bricks|paving_stones:30
        )
