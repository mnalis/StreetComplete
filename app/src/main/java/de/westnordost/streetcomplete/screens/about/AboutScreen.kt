        ...
        Column(modifier = Modifier.verticalScroll(rememberScrollState())) {
            ...
            PreferenceCategory(stringResource(R.string.about_category_help)) {
                ...
                Preference(
                    ...
                    onClick = { context.openUri("https://github.com/mnalis/StreetComplete/issues") },
                ) { OpenInBrowserIcon() }
            ...
            PreferenceCategory(stringResource(R.string.about_category_contribute)) {
                ...
                Preference(
                    ...
                    onClick = { context.openUri("https://github.com/mnalis/StreetComplete") },
                ) { OpenInBrowserIcon() }
            }
            ...
            PreferenceCategory(stringResource(R.string.about_category_feedback)) {
                ...
                Preference(
                    ...
                    onClick = { context.openUri("https://github.com/mnalis/StreetComplete/discussions") },
                ) { OpenInBrowserIcon() }
            }
        }
    }
